...
def upgrade() -> None:
    ...
    # Drop tables with foreign key dependencies first (if they exist)
    ...
    if "my_agents" in existing_tables:
        op.drop_table("my_agents")

    # Drop remaining tables
    if "user_states" in existing_tables:
        op.drop_table("user_states")

    if "app_states" in existing_tables:
